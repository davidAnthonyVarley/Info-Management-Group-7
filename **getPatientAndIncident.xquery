...
declare function local:get_patient_status($stat , $id as xs:string) {
  ...
  return 
    concat(
      "Patient Status Information", $nl, 
      "Injuries: ", string-join($patientStatus/PatientStatus.injuries/data, ", "), $nl,  
      "Heart rate: ", $patientStatus/PatientStatus.heartRate/@bpm, $nl, 
      "BP systolic: ", $patientStatus/PatientStatus.bloodPressureSystolic/@mmHg, $nl, 
      "BP diastolic: ", $patientStatus/PatientStatus.bloodPressureDiastolic/@mmHg, $nl, 
      "Arrived: ", $patientStatus/PatientStatus.arrivedAtHospital/@arrived, $nl
    )
